...
export const AnalyticsNewTrends: React.FC = () => {
  ...
  const { datePreset, dataSource, setDataSource } = useAnalyticsNewFilters();
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
            <Label htmlFor="trends-data-source-toggle" className="text-sm font-medium text-gray-700 cursor-pointer">
              Data Source:
            </Label>
