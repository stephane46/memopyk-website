      ...
      <footer id="footer" className="bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-semibold mb-4 footer-main-heading">
              ...
              <ul className="space-y-2">
                <li>
                  <button 
                    ...
                    className="footer-main-link transition-colors"
                  >
                    {t('nav.our-service')}
                  </button>
                </li>
                ...
                <li>
                  <Link 
                    href={language === 'fr-FR' ? '/fr-FR/annuaire-pro' : '/en-US/directory-pro'}
                    className="footer-main-link transition-colors"
                  >
                    {t('nav.partner-directory')}
                  </Link>
                </li>
                <li>
                  <button 
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href={getLocalizedPath('/legal/legal-notice')} className="footer-main-link">
                  {language === 'fr-FR' ? 'Mentions légales' : 'Legal Notice'}
                </Link></li>
                <li><Link href={getLocalizedPath('/legal/terms-of-service')} className="footer-main-link">
                  {language === 'fr-FR' ? 'Conditions générales d\'utilisation' : 'Terms of Service'}
                </Link></li>
                <li><Link href={getLocalizedPath('/legal/terms-of-sale')} className="footer-main-link">
                  {language === 'fr-FR' ? 'Conditions générales de vente' : 'Terms of Sale'}
                </Link></li>
                <li><Link href={getLocalizedPath('/legal/privacy-policy')} className="footer-main-link">
                  {language === 'fr-FR' ? 'Politique de confidentialité' : 'Privacy Policy'}
                </Link></li>
                <li><Link href={getLocalizedPath('/legal/cookie-policy')} className="footer-main-link">
            ...
            <div>
              <h4 id="footer-contact-title" className="font-semibold mb-4 footer-main-heading cursor-pointer transition-all duration-300 ease-in-out transform hover:translate-x-1 hover:text-memopyk-orange hover:font-bold">Contact</h4>
              <ul className="space-y-3">
                <li>
                  <a 
                    id="footer-email"
                    href="mailto:contact@memopyk.com"
                    className="flex items-center gap-3 footer-main-link cursor-pointer p-2 -m-2 rounded-lg"
                  >
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2026 MEMOPYK. {language === 'fr-FR' ? 'Tous droits réservés.' : 'All rights reserved.'}</p>
            <div className="mt-2">
