      ...
      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
        <div className="mb-3">
          ...
          <p className="text-xs text-orange-600 mt-1">
            Exclude all data before the specified date. Applies to MEMOPYK logs only (not GA4).
          </p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage IP addresses excluded from MEMOPYK analytics (toggle ON = excluded, OFF = counted). Does not affect GA4 data.
          </p>
        </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col gap-1">
                        <Badge variant={exclusion.active ? "default" : "secondary"} className={exclusion.active ? "bg-orange-500 hover:bg-orange-600" : "bg-green-500"}>
                          {exclusion.active ? '🚫 Excluded' : '✅ Counting'}
                        </Badge>
                        <span className="text-xs text-gray-500">
                          {exclusion.active ? 'Hidden from analytics' : 'Visible in analytics'}
                        </span>
                      </div>
                    </div>
                  </TableCell>
