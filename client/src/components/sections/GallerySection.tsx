    ...
    <section id="gallery" className="py-12 bg-gradient-to-br from-memopyk-cream/30 to-white">
      <div className="container mx-auto px-4" ref={galleryRef}>
        ...
        <div className="text-center mt-16">
          <div className="relative bg-gradient-to-br from-memopyk-dark-blue via-memopyk-navy to-memopyk-dark-blue p-10 rounded-3xl shadow-2xl border border-memopyk-orange/20 overflow-hidden pricing-cta-wrapper">
            {/* Decorative Elements */}
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-6">
                <h3 className="text-xl md:text-2xl font-bold mb-4 pricing-cta-title">
                  {language === 'fr-FR' ? "TARIFS SUR MESURE POUR CHAQUE HISTOIRE" : "PERSONALIZED PRICING FOR EVERY STORY"}
                </h3>
                <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed pricing-cta-text">
                  {language === 'fr-FR' 
                ...
                <p className="text-lg font-semibold mt-4 pricing-cta-highlight">
                  {language === 'fr-FR' 
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8 text-sm md:text-base">
                <div className="flex items-center pricing-cta-bullet">
