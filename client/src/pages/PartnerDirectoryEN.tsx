...
import PartnerMapbox, {
  type MapBounds,
  containedInBounds,
} from "@/components/PartnerMapbox";
import {
  PHOTO_FORMATS,
  FILM_FORMATS,
  VIDEO_CASSETTES,
    ...
    queryFn: async () => {
      try {
        const response = await fetch(
          "/api/partners?limit=1000&status=Approved&isActive=true&showOnMap=true&transform=true",
          {
            cache: "no-store",
                        ...
                        >
                          ...
                          {partner.publicDescription && (
                            <div>
                              ...
                              {!isExpanded &&
                                partner.publicDescription.length > 100 && (
                                  <button
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      setExpandedCard(partner.slug);
