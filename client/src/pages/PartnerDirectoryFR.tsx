...
// Fix Leaflet default icon issue - Vite compatible
...
export default function PartnerDirectoryFR() {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => {
      const subtitle = document.querySelector('[data-testid="header-subtitle-fr"]');
      if (subtitle) {
    ...
    <div className="min-h-screen bg-[#F2EBDC]">
      ...
      <div className="bg-gradient-to-r from-[#2A4759] to-[#011526] text-white py-6">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-white" data-testid="header-subtitle-fr">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 text-[#F2EBDC]">
                              <MapPin 
                                ...
                                ref={(el) => { if (el) el.style.setProperty('stroke', '#FFFFFF', 'important'); }}
                              />
                              <span 
                                className="text-sm" 
                                data-testid={`partner-location-${partner.slug}`}
                                ref={(el) => { if (el) el.style.setProperty('color', '#F2EBDC', 'important'); }}
                              >
